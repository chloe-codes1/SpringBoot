...
public class HandcodingController {
	...
	public String multiplePhotoUpload(HttpServletRequest request) {
		...
		try {
			...
			// 파일 기본경로 _ 상세경로
			String filePath = request.getSession().getServletContext().getRealPath("/resources/photoUpload/");   //  "D:/workspace/Spring/src/main/webapp/resources/photoUpload/";
			...
			sb.append("&bNewLine=true")
			  ...
			  .append("&sFileURL=").append("http://localhost/xxx/resources/photoUpload/").append(saveName);
		} catch (Exception e) {
			e.printStackTrace();
		}
		return sb.toString();
